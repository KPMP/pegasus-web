...
class RNASeqVizNewSN extends Component {
  ...
  async componentDidMount() {
    ...
    if (
      ...
      (!queryParam || !queryParam.dataType)
    ) {
  ...
  render() {
    return (
      <div className="height-wrapper mb-3">
        <h1>YOU ARE ON THE NEW SINGLE-CELL/SINGLE-NUC DATA VIZ PAGE</h1>
          ...
          <Container className="mt-3 rounded border p-3 shadow-sm mb-5">
            <Row xs="12">
              ...
              <Col lg="6">
                ...
                <Row
                  className={
                    !this.state.isLoadingUmap &&
                    !this.props.gene.symbol &&
                    this.state.plotData.length >= 0
                      ? "featurePlot-loader-background"
                      : ""
                  }
                >
                  <Col lg="12" className="featurePlot-container">
                    <FeaturePlot
                      ...
                      isLoading={this.state.isLoadingUmap}
                      gene={this.props.gene.symbol}
                      enrollmentCategory={this.props.enrollmentCategory}
                    />
                  </Col>
                </Row>
            ...
            <Row>
              <Col>
                {!this.state.isLoading &&
                  this.state.geneExpressionData.length > 0 && <hr />}
              </Col>
            </Row>
            <ExpressionXCellType
              dataType={this.props.dataType}
              data={this.state.geneExpressionData}
