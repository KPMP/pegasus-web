...
class DataTypeSelector extends Component {
    ...
    getDataTypeInfo = (dataType) => {
        let copy = {
            'sn': 'This single-nucleus dataset is comprised of Healthy Reference: KPMP Healthy Reference Living Donor protocol biopsies (23 samples from 22 participants), KPMP Healthy Reference Percutaneous Nephrolithotomy protocol biopsies (2), KPMP Tumor Nephrectomy tissue (10 samples from 6 participants), and tissue samples from Human Biomolecular Atlas Program (HuBMAP) and Washington University St. Louis (WUSTL) Kidney Translational Research Center (KTRC) participants (15 samples from 10 participants); CKD: biopsy samples from the KPMP Main Study protocol participants (73 samples from 72 particpants); AKI: biopsy samples from the KPMP Main Study protocol participants (35 samples from 34 participants); and DM-R: biopsy samples from the KPMP Main Study protocol participants (11).',
            'sc': 'This single-cell dataset is comprised of Healthy Reference: KPMP Healthy Reference Living Donor protocol biopsies (10), KPMP Healthy Reference Percutaneous Nephrolithotomy protocol biopsies (5), KPMP Tumor Nephrectomy tissue (16 samples from 5 participants) and Human Cell Atlas Living Donor biopsies (20 samples from 18 participants); CKD: biopsy samples from the KPMP Main Study protocol participants (53 samples from 51 participants); AKI: biopsy samples from the KPMP Main Study protocol participants (20); and DM-R: biopsy samples from the KPMP Main Study protocol participants (3)',
                            ...
                            <div>
                                ...
                                {(this.props.dataType === 'sc' ) &&
                                    <CellXGeneDropdown v1="https://cellxgene.cziscience.com/e/32b9bdce-2481-4c85-ba1b-6ad5fcea844c.cxg/"
                                                       ...
                                                       v2="https://cellxgene.cziscience.com/e/91f31e05-56d8-46fc-b408-d90c9228a81b.cxg/"/>
                                }
                                { (this.props.dataType === 'sn') &&
                                    <CellXGeneDropdown v1="https://cellxgene.cziscience.com/e/07854d9c-5375-4a9b-ac34-fa919d3c3686.cxg/"
                                                       ...
                                                       v2="https://cellxgene.cziscience.com/e/7ff0197b-d175-49bf-b4fa-150fe0995d93.cxg/"/>
                                }
                            </div>
                            }
                        </Col>
