    ...
    render() {
        var data = [{
            ...
            y: [
                ...
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"experimental_strategy"%2C"value"%3A["Single-nucleus RNA-Seq"]}}%2C{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["Aggregated Clustered Data"]}}]}'>snRNA-Seq aggregated clustered data</a>`,
                ...
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"experimental_strategy"%2C"value"%3A["Single-cell RNA-Seq"]}}%2C{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["Aggregated Clustered Data"]}}]}'>scRNA-Seq aggregated clustered data</a>`,
                ...
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"experimental_strategy"%2C"value"%3A["Regional Transcriptomics"]}}%2C{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["Aggregated Data"]}}]}'>LMD RNA-Seq aggregated data</a>`,
                ...
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["RGB max proj of 8-ch IF image volume"]}}]}'>3D imaging 8-ch RGB max projection</a>`,
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["Composite max proj of 8-ch IF image volume"]}}]}'>3D imaging 8-ch composite max projection</a>`,
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["Composite 3D 8-ch IF image volume"]}}]}'>3D imaging 8-ch composite 3D</a>`,
                `<a href='/repository/?facetTab=files&filters={"op"%3A"and"%2C"content"%3A[{"op"%3A"in"%2C"content"%3A{"field"%3A"workflow_type"%2C"value"%3A["RGB max proj of 2-ch (autofluorescence and second harmonic generation) image volume"]}}]}'>3D imaging 2-ch RGB max projection</a>`,
