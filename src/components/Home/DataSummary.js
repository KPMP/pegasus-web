    ...
    render() {
        ...
        return (
            <Container className="landing mt-3 mb-4 rounded border p-3 shadow-sm">
                ...
                <Row><p>IMPORTANT: Please follow this <a href="https://www.kpmp.org/help-docs/study-overview?tabname=citingkpmpdata" target="_blank">citation guideline</a> when presenting or publishing data from the Kidney Tissue Atlas.</p></Row>
