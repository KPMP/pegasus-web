      ...
      <div id="leftcontent">
        ...
        }
        {
          ...
          <Container className="mt-3 rounded border p-3 shadow-sm">
              ...
              <div className='mt-3'>
                  <Button className="w-100" color='primary' rel="noopener noreferrer" target="_blank" href='https://enclave.kpmp.org' size='lg' block onClick={() => { this.handleGoogleAnalyticsEvent('Atlas Home', 'Navigation', 'Data2Evidence') }}>Go to D2E</Button>
              </div>
          </Container>
        <Container className="mt-3 rounded border p-3 shadow-sm">
