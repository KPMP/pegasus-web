...
import {
  ...
  fetchRegionalProteomicsByStructure,
...
class DiffexByCluster extends Component {
  ...
  getGeneLink = (gene) => {
    return (
      <button
        ...
        type="button"
        className="btn btn-link table-column p-0 text-start"
      >
        {gene}
      </button>
    );
        ...
        title: (
          <span>
            ...
            <span className="icon-info">
              <FontAwesomeIcon
                className="kpmp-light-blue"
                id="fold-change-info"
                icon={faInfoCircle}
              />
            </span>
            <UncontrolledTooltip placement="bottom" target="fold-change-info">
              Fold change of a gene is calculated by dividing the average
              expression of the gene in the segment/cluster of interest by its
              average expression in all other segments/clusters being compared.
            </UncontrolledTooltip>
          </span>
        ),
        field: "foldChange",
        ...
        title: (
          <span>
            ...
            <UncontrolledTooltip placement="bottom" target="pvalue-info">
              P value was calculated using a Wilcoxon rank sum test between the
              expression of the gene in the segment/cluster of interest and its
              expression in all other segments/clusters.
            </UncontrolledTooltip>
          </span>
        ),
        field: "pVal",
        ...
        title: (
          <span>
            ...
            <UncontrolledTooltip placement="bottom" target="pvalue-adj-info">
              Adjusted p-value, based on bonferroni correction using all
  ...
  getExportFilename = () => {
    return (
      "KPMP_" +
      formatDataType(this.props.dataType) +
      "-diffex_" +
      this.props.cluster +
      "_all-samples.csv"
    );
    ...
    return (
      <div className="height-wrapper mb-3 mt-3">
        <Container id="outer-wrapper">
          ...
          />
          <Container className="mb-5 rounded border p-3 shadow-sm">
