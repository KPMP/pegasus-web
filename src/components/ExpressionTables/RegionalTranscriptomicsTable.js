                    ...
                    <div className="ag-theme-material img-fluid" style={{height: '100%', width: '100%'}}>
                        ...
                        >
                            ...
                            <AgGridColumn headerName="FOLD CHANGE"
                                          ...
                                          tooltipComponentParams={{tooltipText:'Fold change of a gene is calculated by dividing the average expression of the gene in the segment/cluster of interest by its average expression in all other segments/clusters being compared.'}}
                            ...
                            <AgGridColumn headerName='P VALUE'
                                          tooltipComponent="customTooltip"
                                          tooltipComponentParams={{tooltipText:'P value was calculated using a Wilcoxon rank sum test between the expression of the gene in the segment/cluster of interest and its expression in all other segments/clusters.'}}
                                          headerTooltip='pVal'
                                          headerComponentFramework={CustomHeader}
