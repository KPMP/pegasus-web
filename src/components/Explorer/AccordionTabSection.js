...
class AccordionTabSection extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.activeCell !== CellTypeEnum.PROXIMAL_TUBULE_EITHELIAL_SEGMENT_1
            && this.props.activeCell == CellTypeEnum.PROXIMAL_TUBULE_EITHELIAL_SEGMENT_1) {
            this.toggleWithoutResetting({ target: { dataset: { event: 0 } } })
            this.setState({ activeCellState: CellTypeEnum.PROXIMAL_TUBULE_EITHELIAL_SEGMENT_1 })
        }
